// src/components/Charts/OfrChart.tsx
...
export default function OFRChart({ chartData, hierarchyChartData }: OFRChartProps) {
  ...
  return (
    <div className={`p-4 rounded-2xl shadow-md ${
      ...
      <ChartModal
        ...
        title={isHierarchyData ? 'Total OFR (l/min)' : 'OFR (bpd)'}
      >
